...
public class ProductRepository {
    ...
    public List<Product> getAllProducts() throws SQLException, ClassNotFoundException {
        ...
        String query = "SELECT p.id, p.sku, p.name,p.description,p.active, p.unit_price, p.image_url, p.units_in_stock, c.id as category_id, c.category_name as category_name FROM product p INNER JOIN product_category c on p.category_id = c.id LIMIT 12";
